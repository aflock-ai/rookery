...
sidebar_position: 6
examples_repo: tool-hadolint-sarif
---
...
- [`sarif` attestor](../attestors/sarif) — the predicate this tool flows through
- [How cilock policy works](../guides/policy) — verify-time enforcement on Hadolint findings
- [Attestation graph + back-refs](../concepts/attestation-graph) — how Dockerfile material links to the image attestation
