    ...
    "results": [
      {
        ...
        "rowCount": 4,
        "resultHash": "9f3c...",
        "rows": [{ "user_name": "alice", "account_id": "339150376714", "mfa_enabled": true }]
      }
    ]
  }
}
...
- Subjects only emit for plugins listed in the convention table (`aws`, `github`, `okta`, `kubernetes`). Other plugins produce no subjects unless the table is extended.
- AWS account IDs decoded as JSON `float64` are rendered as integer strings (`"339150376714"`, not `"3.39150376714e+11"`) before hashing.
