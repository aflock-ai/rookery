...
// all logging output. This is the default logger when using the attestation library,
// so that we don't interfere with the caller's stdout/stderr. Callers
// should supply their own Logger to capture the attestation library logging if desired.
