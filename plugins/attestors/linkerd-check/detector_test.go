...
func TestDetectorPreGateFiresOnArgv(t *testing.T) {
	detectiontest.AssertPreGateFiresOnArgv(t, Name, detectorYAML, []string{"linkerd", "check"})
}

func TestDetectorPostGateFiresOnExec(t *testing.T) {
	detectiontest.AssertPostGateFiresOnExec(t, Name, detectorYAML, []string{"linkerd", "check"})
}

func TestDetectorPostGateFiresOnProduct(t *testing.T) {
	detectiontest.AssertPostGateFiresOnProduct(t, Name, detectorYAML, "linkerd-check*.json")
}
