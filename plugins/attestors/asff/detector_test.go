...
func TestDetectorPreGateFiresOnArgv(t *testing.T) {
	detectiontest.AssertPreGateFiresOnArgv(t, Name, detectorYAML, []string{"aws", "securityhub", "get-findings"})
}

func TestDetectorPostGateFiresOnExec(t *testing.T) {
	detectiontest.AssertPostGateFiresOnExec(t, Name, detectorYAML, []string{"aws", "securityhub", "get-findings"})
}

func TestDetectorPostGateFiresOnProduct(t *testing.T) {
	detectiontest.AssertPostGateFiresOnProduct(t, Name, detectorYAML, "sample.asff.json")
}
