...
import (
	...
	_ "github.com/aflock-ai/rookery/plugins/attestors/sarif" // register the sarif attestor
)

// TestFixtures proves the sarif output contract against its recorded fixtures
...
// in CI). Hermetic: no real gosec run, the fixture input is a recorded report.
