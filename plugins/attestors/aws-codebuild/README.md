...
This attestor captures AWS CodeBuild metadata and provenance when running within AWS CodeBuild CI/CD pipelines. It collects information about the build, project, source code, and other AWS CodeBuild-specific metadata to provide a verifiable record of the build environment.

## Usage

To use the AWS CodeBuild attestor, include it in your attestation invocation:
