...
func TestDetectorPreGateFiresOnArgv(t *testing.T) {
	detectiontest.AssertPreGateFiresOnArgv(t, Name, detectorYAML, []string{"falco"})
}

func TestDetectorPostGateFiresOnExec(t *testing.T) {
	detectiontest.AssertPostGateFiresOnExec(t, Name, detectorYAML, []string{"falco"})
}

func TestDetectorPostGateFiresOnProduct(t *testing.T) {
	detectiontest.AssertPostGateFiresOnProduct(t, Name, detectorYAML, "falco*.json")
}
