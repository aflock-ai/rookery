...
const (
	Name    = "docker"
	Type    = "https://aflock.ai/attestations/docker/v0.1"
...
func (a *Attestor) setDockerCandidate(met *BuildInfo) error {
...
func (a *Attestor) getDockerCandidates(ctx *attestation.AttestationContext) ([]BuildInfo, error) {
