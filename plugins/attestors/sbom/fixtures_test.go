...
import (
	...
	_ "github.com/aflock-ai/rookery/plugins/attestors/sbom" // register the sbom attestor
)

// TestFixtures proves the sbom output contract against its recorded fixtures
...
// in CI). Hermetic: no real syft run, the fixture input is a recorded SBOM.
