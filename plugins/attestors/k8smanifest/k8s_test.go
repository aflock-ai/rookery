...
metadata:
  ...
  resourceVersion: "111"
  annotations:
    aflock.ai/content-hash: "somehash"
status:
  ready: false
`
...
`
	...
	require.NotContains(t, annotations, "aflock.ai/content-hash", "should remove ephemeral annotation")
...
func TestK8smanifest_WithExtraIgnoreAnnotations(t *testing.T) {
	...
	k8smanifest.WithExtraIgnoreAnnotations("aflock.ai/special-annotation")(km)
	require.Contains(t, km.IgnoreAnnotations, "aflock.ai/special-annotation")
}
