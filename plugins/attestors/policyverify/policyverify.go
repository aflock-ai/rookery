...
func (a *Attestor) Attest(ctx *attestation.AttestationContext) error { //nolint:funlen,gocyclo // policy verification requires extensive setup + chain-sidecar branch wiring
