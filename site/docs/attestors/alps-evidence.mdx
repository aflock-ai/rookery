...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/alps-evidence.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/alps-evidence.json';

# `alps-evidence` attestor
...
- [`environment`](./environment.mdx)
- [`git`](./git.mdx)

<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"alps-evidence — cilock attestor\",\"description\":\"Observe which coding-agent process appears in cilock's ancestry, with bounded version, model, sandbox, configuration, and environment context that is explicitly non-enforcing.\",\"url\":\"https://cilock.dev/attestors/alps-evidence\"}"}} />

<GeneratedFooter name="alps-evidence" />
