...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/sarif.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/sarif.json';
...
- [`sbom` attestor](./sbom.mdx)
- Upstream: [witness/sarif.md](https://github.com/in-toto/witness/blob/main/docs/attestors/sarif.md)

<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"sarif — cilock attestor\",\"description\":\"The cilock sarif attestor captures a SARIF result file emitted by a code scanner (CodeQL, Semgrep, gosec, Trivy) and embeds it byte-identical in a signed in-toto attestation under a .report field.\",\"url\":\"https://cilock.aflock.ai/attestors/sarif\"}"}} />

<GeneratedFooter name="sarif" />
