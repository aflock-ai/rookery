...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/slsa.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/slsa.json';
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"slsa — cilock attestor\",\"description\":\"The cilock slsa attestor assembles a SLSA Provenance v1.0 predicate from sibling attestors in the same collection and signs it into in-toto evidence under the slsa.dev predicate type.\",\"url\":\"https://cilock.aflock.ai/attestors/slsa\"}"}} />

<GeneratedFooter name="slsa" />
