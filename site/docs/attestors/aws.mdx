...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/aws.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/aws.json';
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"aws (aws-iid) — cilock attestor\",\"description\":\"The cilock aws attestor fetches the EC2 instance identity document from IMDS, verifies its RSA-SHA256 signature against the AWS region certificate, and signs the verified host identity into in-toto evidence.\",\"url\":\"https://cilock.aflock.ai/attestors/aws\"}"}} />

<GeneratedFooter name="aws" />
