...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/vex.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/vex.json';
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"vex — cilock attestor\",\"description\":\"The cilock vex attestor captures an OpenVEX document found among a step's product files and attaches it as in-toto evidence under the canonical OpenVEX predicate type URI.\",\"url\":\"https://cilock.aflock.ai/attestors/vex\"}"}} />

<GeneratedFooter name="vex" />
