...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/command-run.doc.md. Regenerate: npm run gen */}
...
import meta_v0_2 from '@catalog/command-run.json';
import meta_v0_1 from '@catalog/command-run-v0.1.json';

# `command-run` attestor

<VersionedDoc versions={["v0.2","v0.1"]} latest="v0.2">
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"command-run — cilock attestor\",\"description\":\"The cilock command-run attestor records the executed argv, exit code, captured stdout/stderr, and an optional Linux ptrace forensic record, signed into in-toto evidence.\",\"url\":\"https://cilock.aflock.ai/attestors/command-run\"}"}} />

<GeneratedFooter name="command-run" />
