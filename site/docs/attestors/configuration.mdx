...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"configuration — cilock attestor\",\"description\":\"The cilock configuration attestor captures the raw CLI flags, config file path, digest, and parsed contents that drove a run, signing them into in-toto evidence.\",\"url\":\"https://cilock.aflock.ai/attestors/configuration\"}"}} />
