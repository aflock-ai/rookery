...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"aws-codebuild — cilock attestor\",\"description\":\"The cilock aws-codebuild attestor captures CodeBuild build identity from CODEBUILD_* env vars and the BatchGetBuilds API, signing the full build context into in-toto evidence.\",\"url\":\"https://cilock.dev/attestors/aws-codebuild\"}"}} />
