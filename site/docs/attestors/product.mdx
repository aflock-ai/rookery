...
This is the sole trust path. Inline leaves are always present in v0.3 attestations. See [verify a specific file](../guides/verify-a-specific-file.md) for the full check sequence.
