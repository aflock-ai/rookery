...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/prowler.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/prowler.json';
...
The summary lets policy gate on failure counts or specific failed `checkId`s without carrying the full report inline. Pair with [`policyverify`](./policyverify.mdx) to gate promotion.
...
- [`aws-config`](./aws-config.md), [`asff`](./asff.md)
- [Tools index](./)

<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"Prowler — cilock attestor\",\"description\":\"Scan AWS, GCP, Azure, Kubernetes, and Microsoft 365 against CIS, NIST, ISO 27001, HIPAA, and PCI-DSS with Prowler under cilock — findings become a signed v0.3 attestation parsed by the native prowler attestor.\",\"url\":\"https://cilock.dev/attestors/prowler\"}"}} />

<GeneratedFooter name="prowler" />
