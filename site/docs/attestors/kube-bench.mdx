...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/kube-bench.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/kube-bench.json';
...
- [`docker-bench`](./docker-bench.md), [`inspec`](./inspec.mdx)
- Upstream: [witness/kube-bench.md](https://github.com/in-toto/witness/blob/main/docs/attestors/kube-bench.md)

<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"kube-bench — cilock attestor\",\"description\":\"The cilock kube-bench attestor ingests an Aqua Security kube-bench CIS Kubernetes Benchmark JSON report from the step's products and signs a per-check pass/fail/warn summary into in-toto evidence.\",\"url\":\"https://cilock.aflock.ai/attestors/kube-bench\"}"}} />

<GeneratedFooter name="kube-bench" />
