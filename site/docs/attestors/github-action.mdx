...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/github-action.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/github-action.json';

# `github-action` attestor
...
- [`github`](./github.mdx) for OIDC claims
- [GitHub Action reference](../reference/github-action.md)

<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"github-action — cilock attestor\",\"description\":\"The cilock github-action attestor captures GitHub Action execution metadata — reference, type, inputs/outputs, exit code, and runtime context — signed into in-toto evidence.\",\"url\":\"https://cilock.aflock.ai/attestors/github-action\"}"}} />

<GeneratedFooter name="github-action" />
