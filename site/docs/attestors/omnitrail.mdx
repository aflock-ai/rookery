...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/omnitrail.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/omnitrail.json';
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"omnitrail — cilock attestor\",\"description\":\"The cilock omnitrail attestor captures a content-addressed trail of every file and directory under the working directory with POSIX metadata, signed into in-toto evidence for cross-tool provenance correlation.\",\"url\":\"https://cilock.aflock.ai/attestors/omnitrail\"}"}} />

<GeneratedFooter name="omnitrail" />
