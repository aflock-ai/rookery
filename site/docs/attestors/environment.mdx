...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"environment — cilock attestor\",\"description\":\"The cilock environment attestor captures the host OS, hostname, username, and full process environment with sensitive values obfuscated, signing them into in-toto evidence.\",\"url\":\"https://cilock.aflock.ai/attestors/environment\"}"}} />
