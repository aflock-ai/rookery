...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"OSV-Scanner — cilock tool integration\",\"description\":\"Scan lockfiles or containers against the OpenSSF OSV vulnerability database with OSV-Scanner under cilock — each match becomes a signed v0.3 SARIF attestation.\",\"url\":\"https://cilock.dev/tools/osv-scanner\"}"}} />
