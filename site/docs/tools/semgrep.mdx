...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/semgrep.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/semgrep.json';
...
- [Attestation graph + back-refs](../concepts/the-spine-of-the-graph.md) — how scans link to artifacts via subject digests
- [Tools index](./index.md)

<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"Semgrep — cilock tool integration\",\"description\":\"Run Semgrep SAST under cilock — the SARIF report becomes a signed v0.3 attestation parsed by the rookery sarif attestor; supports any of Semgrep's bundled rulesets or custom rules.\",\"url\":\"https://cilock.aflock.ai/tools/semgrep\"}"}} />

<GeneratedFooter name="semgrep" />
