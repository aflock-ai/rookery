...
{/* GENERATED — do not edit. Source: rookery attestation/detection/docs/testssl.doc.md. Regenerate: npm run gen */}
...
import meta from '@catalog/testssl.json';
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"TechArticle\",\"headline\":\"testssl.sh — cilock tool integration\",\"description\":\"Run testssl.sh TLS connection scans under cilock — the testssl JSON output becomes a signed v0.3 attestation parsed by the rookery sarif attestor, capturing protocol negotiation, cipher matrix, named TLS vulnerabilities, and FIPS 140-2/140-3 compliance findings.\",\"url\":\"https://cilock.dev/tools/testssl\"}"}} />

<GeneratedFooter name="testssl" />
